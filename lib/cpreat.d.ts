export = cpreact;
export as namespace cpreact;

declare namespace cpreact {
  ...
  type ComponentFactory<P> = ComponentConstructor<P> | FunctionalComponent<P>;
	/**
	 * Define the contract for a virtual node in cpreact.
	 *
	 * A virtual node has a name, a map of attributes, an array
	 * of child {VNode}s and a key. The key is used by cpreact for
	 * internal purposes.
	 */
...
declare global {
  namespace JSX {
    interface Element extends cpreact.VNode<any> {
    }

    interface ElementClass extends cpreact.Component<any, any> {
    }
    ...
    interface DOMAttributes extends cpreact.PreactDOMAttributes {
      // Image Events
    ...
    interface HTMLAttributes extends cpreact.PreactHTMLAttributes, DOMAttributes {
